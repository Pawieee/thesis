...
def get_pretraining_transforms(input_shape=(224, 224), preprocess=False, augment=True):
    ...
    if augment:
        # LIGHT PREPROCESSING / AUGMENTATION
        # We fill with 255 because at this stage, the image is still black ink on WHITE paper.
    ...
    if preprocess:
        # HARD PREPROCESSING
        # This function now receives the rotated/flipped image and 
        # handles Thresholding -> Inversion -> Morphology -> Crop -> Pad -> Norm
